...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b82458, const void *arg_0xb7b825f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b338c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79dd840), 
int (*key_eq_fn)(void *arg_0xb79ddc88, void *arg_0xb79dde00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78ac9b8, int arg_0xb78acb10);
static double RandomUniform(void );
...
#line 131
static void LoraWANC$save_send_msg(saved_msg_t save_msg, lora_msg_t *received_pkt, uint8_t index);
...
static inline void LoraWANC$handle_msg(saved_msg_t save_msg, lora_msg_t *received_pkt);
#line 163
...
#line 141
{
  ...
  sensor_index = __nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1;
  if (__nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[sensor_index].nxdata) == 0 && __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[sensor_index].nxdata) == 0) {
      LoraWANC$save_send_msg(LoraWANC$saved_msg[sim_node()], received_pkt, sensor_index);
    }
  else {
    if (__nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[sensor_index].nxdata) != __nesc_ntoh_uint8(received_pkt->id.nxdata)) {
        ...
        sim_log_debug(150U, "server_node", "DUPLICATE FOUND!!!\n");
      }
    }
}
...
#line 288
          ...
          if (TOS_NODE_ID == 6 || TOS_NODE_ID == 7) {
              sim_log_debug(163U, "gateway_node", "ACK ARRIVED at gateway %d\n \t\t\tGATEWAY: %d\n \t\t\tSENDER: %d\n \t\t\tID: %d\n \t\t\tCONTENT: %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(received_pkt->gateway.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata));
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb764eac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb764eac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb764eac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7403498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7403498, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb764e108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb764e108, msg, error);
#line 110
}
#line 110
...
{
  if (err == SUCCESS) {
      sim_log_debug(152U, "radio", "Radio on on node %d! at time %s\n", TOS_NODE_ID, sim_time_string());
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7406a98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7406a98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7406a98, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7808650){
#line 75
  switch (arg_0xb7808650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7808650);
#line 75
      break;
#line 75
    }
...
#line 228
      ...
      sim_log_debug(155U, "sensor_node", "TIME EXPIRED\n");
      sim_log_debug(156U, "sensor_node", "RESEND MSG with ID: %d and CONTENT: %d\n", LoraWANC$current_id[sim_node()], LoraWANC$current_content[sim_node()]);
      ...
      sim_log_debug(157U, "sensor_node", "ACK ARRIVED CORRECTLY!\n");
      LoraWANC$flag_ack[sim_node()] = FALSE;
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb72853a8){
#line 83
  switch (arg_0xb72853a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb72853a8);
#line 83
      break;
#line 83
    }
...
#line 131
{
  __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].node[index].nxdata, __nesc_ntoh_uint8(received_pkt->sender.nxdata));
  __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].id[index].nxdata, __nesc_ntoh_uint8(received_pkt->id.nxdata));
  __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].content[index].nxdata, __nesc_ntoh_uint8(received_pkt->content.nxdata));

  sprintf(LoraWANC$message[sim_node()], "NODE: %d ID: %d CONTENT: %d\n", __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[index].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[index].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[index].nxdata));
...
#line 72
  if (LoraWANC$locked[sim_node()]) {
      ...
      if (LoraWANC$AMSend$send(address, packet, sizeof(lora_msg_t )) == SUCCESS) {
          ...
          sim_log_debug(149U, "radio_send", "Sending packet of type %d at time %s toward node %d\n", __nesc_ntoh_uint8(packet_to_send->type.nxdata), sim_time_string(), address, __nesc_ntoh_uint8(packet_to_send->gateway.nxdata));
        }
    }
}
