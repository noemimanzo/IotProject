...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LoraWANC$Timer0$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
...
#line 198
      switch (__nesc_ntoh_uint8(current_pkt->type.nxdata)) {
          ...
          LoraWANC$current_msg_id[sim_node()] = __nesc_ntoh_uint8(current_pkt->id.nxdata);
          if (TOS_NODE_ID == LoraWANC$server_node[sim_node()]) {



              sim_log_debug(159U, "radio_rec", "msg arrived at server %d from gateway %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(current_pkt->gateway.nxdata));
            ...
            {
              sim_log_debug(160U, "radio_rec", "msg arrived at gat %d from node %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(current_pkt->sender.nxdata));
          ...
          if (TOS_NODE_ID == 6 || TOS_NODE_ID == 7) {
              LoraWANC$fill_pkt(packet_to_send, 1, __nesc_ntoh_uint8(current_pkt->id.nxdata), __nesc_ntoh_uint8(current_pkt->sender.nxdata), 0, 0);
              sim_log_debug(161U, "radio_rec", "ACK arrived at gat %d\n", TOS_NODE_ID);

              LoraWANC$actual_send(__nesc_ntoh_uint8(current_pkt->sender.nxdata), &LoraWANC$packet[sim_node()]);
            }
          else {
              sim_log_debug(162U, "radio_rec", "ACK arrived at node %d\n", TOS_NODE_ID);
              sim_log_debug(163U, "radio_rec", "current_msg_id: %d\n current_pkt_id: %d\n sender: %d\n node: %d\n", LoraWANC$current_msg_id[sim_node()], __nesc_ntoh_uint8(current_pkt->id.nxdata), __nesc_ntoh_uint8(current_pkt->sender.nxdata), TOS_NODE_ID);
              if (LoraWANC$current_msg_id[sim_node()] == __nesc_ntoh_uint8(current_pkt->id.nxdata) && __nesc_ntoh_uint8(current_pkt->sender.nxdata) == TOS_NODE_ID) {
                  ...
                  sim_log_debug(164U, "radio_rec", "flag check %d\n", LoraWANC$flag_ack[sim_node()]);
                }
              else 
#line 242
                {
                  LoraWANC$flag_ack[sim_node()] = FALSE;
                  sim_log_debug(165U, "radio_rec", "flag check %d\n", LoraWANC$flag_ack[sim_node()]);
                }
            }
          break;
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76a2298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76a2298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76a2298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7535730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7535730, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76b18b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76b18b0, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76a2930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76a2930, msg, payload, len);
#line 78
...
#line 104
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LoraWANC$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 97
{
  if (err == SUCCESS) {
      ...
      if ((((TOS_NODE_ID == 1 || TOS_NODE_ID == 2) || TOS_NODE_ID == 3) || TOS_NODE_ID == 4) || TOS_NODE_ID == 5) {
          LoraWANC$Timer0$startOneShot(10000);
        }
    }
  else {
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7538ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7538ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7538ca8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 123
  ...
  LoraWANC$Timer1$startOneShot(3000);
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73b53a8){
#line 83
  switch (arg_0xb73b53a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73b53a8);
#line 83
      break;
#line 83
    }
...
#line 66
  if (LoraWANC$locked[sim_node()]) {
      ...
      if (LoraWANC$AMSend$send(address, packet, sizeof(lora_msg_t )) == SUCCESS) {
          ...
          sim_log_debug(148U, "radio_send", "Sending packet of type %d at time %s\n", __nesc_ntoh_uint8(packet_to_send->type.nxdata), sim_time_string());
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "LoraWANC$current_msg_id"))
  {
    *addr = (uintptr_t)&LoraWANC$current_msg_id[__nesc_mote];
    *size = sizeof(LoraWANC$current_msg_id[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&LoraWANC$current_msg_id[__nesc_mote], 0, sizeof LoraWANC$current_msg_id[__nesc_mote]);
