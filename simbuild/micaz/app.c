...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b2e458, const void *arg_0xb7b2e5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7adf8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7989840), 
int (*key_eq_fn)(void *arg_0xb7989c88, void *arg_0xb7989e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78589b8, int arg_0xb7858b10);
static double RandomUniform(void );
...
} __attribute__((packed)) saved_msg_t;
...
#line 233
extern int listen(int __fd, int __n) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
typedef TMilli LoraWANC$Timer0$precision_tag;
typedef TMilli LoraWANC$Timer1$precision_tag;
...
static void LoraWANC$Timer0$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void LoraWANC$AMControl$startDone(error_t error);
#line 138
static void LoraWANC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void LoraWANC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void LoraWANC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LoraWANC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LoraWANC$Timer0$startPeriodicAt(uint32_t t0, uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t LoraWANC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t LoraWANC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t LoraWANC$Random$rand16(void );
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LoraWANC$Timer1$startOneShot(uint32_t dt);
# 32 "LoraWANC.nc"
message_t LoraWANC$packet[1000];

bool LoraWANC$locked[1000];


uint8_t LoraWANC$id_index[1000];

uint8_t LoraWANC$msg_val[1000];
saved_msg_t LoraWANC$saved_msg[1000];

uint8_t LoraWANC$current_type[1000];
uint8_t LoraWANC$current_id[1000];
uint8_t LoraWANC$current_sender[1000];
uint8_t LoraWANC$current_content[1000];

uint8_t LoraWANC$i[1000];
...
int LoraWANC$server_fd[1000];
#line 54
int LoraWANC$new_socket[1000];
struct sockaddr_in LoraWANC$address[1000];
int LoraWANC$addrlen[1000];
char LoraWANC$message[1000][100];
int LoraWANC$message_len[1000];
...
#line 97
static inline int LoraWANC$open_connection_tcp(void );
#line 132
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * LoraWANC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
{
#line 236
  if (len != sizeof(lora_msg_t ) || LoraWANC$locked[sim_node()]) {
#line 236
      return bufPtr;
    }
  else 
...
#line 243
          ...
          if (TOS_NODE_ID == LoraWANC$server_node[sim_node()]) {
...
#line 249
                {
                  ...
                  sim_log_debug(159U, "server_node", "MSG arrived at server %d from gateway %d\n \t\t\tid: %d\n \t\t\tsender: %d\n \t\t\tcontent:%d\n", TOS_NODE_ID, __nesc_ntoh_uint8(received_pkt->gateway.nxdata), __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata));


                  if (__nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata) == 0 && __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata) == 0) {
                      __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].node[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->sender.nxdata));
                      __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].id[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->id.nxdata));
                      __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].content[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->content.nxdata));
                      sprintf(LoraWANC$message[sim_node()], "NODE: %d ID: %d CONTENT: %d\n", __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata));
                      LoraWANC$message_len[sim_node()] = strlen(LoraWANC$message[sim_node()]);
                      send(LoraWANC$new_socket[sim_node()], LoraWANC$message[sim_node()], LoraWANC$message_len[sim_node()], 0);
                    }
                  else {
                    if (__nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata) != __nesc_ntoh_uint8(received_pkt->id.nxdata)) {
                        for (LoraWANC$i[sim_node()] = 0; LoraWANC$i[sim_node()] < 5; LoraWANC$i[sim_node()]++) {
                            __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].node[LoraWANC$i[sim_node()]].nxdata, 0);
                            __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].id[LoraWANC$i[sim_node()]].nxdata, 0);
                            __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].content[LoraWANC$i[sim_node()]].nxdata, 0);
                          }
                        __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].node[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->sender.nxdata));
                        __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].id[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->id.nxdata));
                        __nesc_hton_uint8(LoraWANC$saved_msg[sim_node()].content[__nesc_ntoh_uint8(received_pkt->sender.nxdata) - 1].nxdata, __nesc_ntoh_uint8(received_pkt->content.nxdata));
                        ...
                        sim_log_debug(160U, "server_node", "DUPLICATE FOUND!!!\n");
                      }
                    }
                  sim_log_debug(161U, "server_node", "MSG SAVED TABLE\n\t\t\tNODE:%d,%d,%d,%d,%d\n", __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[0].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[1].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[2].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[3].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].node[4].nxdata));
                  sim_log_debug_clear(162U, "server_node", "\t\t\tID:%d,%d,%d,%d,%d\n", __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[0].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[1].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[2].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[3].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].id[4].nxdata));
                  sim_log_debug_clear(163U, "server_node", "\t\t\tCONTENT:%d,%d,%d,%d,%d\n", __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[0].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[1].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[2].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[3].nxdata), __nesc_ntoh_uint8(LoraWANC$saved_msg[sim_node()].content[4].nxdata));


                  LoraWANC$fill_pkt(packet_to_send, 1, __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata), __nesc_ntoh_uint8(received_pkt->gateway.nxdata));

                  LoraWANC$actual_send(__nesc_ntoh_uint8(received_pkt->gateway.nxdata), &LoraWANC$packet[sim_node()]);
                  sim_log_debug(164U, "server_node", "GATEWAY: %d\n", __nesc_ntoh_uint8(received_pkt->gateway.nxdata));
                }
            }
          else 
            {
              sim_log_debug(165U, "radio_rec", "MSG arrived at gat %d from node %d\n \t\t\tid: %d\n \t\t\tcontent:%d\n", TOS_NODE_ID, __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata));
              LoraWANC$fill_pkt(packet_to_send, 0, __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata), TOS_NODE_ID);
...
#line 303
          ...
          if (TOS_NODE_ID == 6 || TOS_NODE_ID == 7) {
              sim_log_debug(166U, "radio_rec", "ACK arrived at gat %d\n \t\t\tgateway: %d\n \t\t\tid: %d\n \t\t\tsender: %d\n \t\t\tcontent: %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(received_pkt->gateway.nxdata), __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->content.nxdata));
              LoraWANC$fill_pkt(packet_to_send, 1, __nesc_ntoh_uint8(received_pkt->id.nxdata), __nesc_ntoh_uint8(received_pkt->sender.nxdata), 0, 0);

              LoraWANC$actual_send(__nesc_ntoh_uint8(received_pkt->sender.nxdata), &LoraWANC$packet[sim_node()]);
            }
          else {

            if ((((TOS_NODE_ID == 1 || TOS_NODE_ID == 2) || TOS_NODE_ID == 3) || TOS_NODE_ID == 4) || TOS_NODE_ID == 5) {
                sim_log_debug(167U, "radio_rec", "ACK arrived at node %d\n \t\t\tsender: %d\n \t\t\tid: %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(received_pkt->sender.nxdata), __nesc_ntoh_uint8(received_pkt->id.nxdata));
                sim_log_debug(168U, "radio_rec", "CHECK ID ACK: id_msgSent: %d  id_ackReceived: %d\n", LoraWANC$current_id[sim_node()], __nesc_ntoh_uint8(received_pkt->id.nxdata));
                if (LoraWANC$current_id[sim_node()] == __nesc_ntoh_uint8(received_pkt->id.nxdata) && __nesc_ntoh_uint8(received_pkt->sender.nxdata) == TOS_NODE_ID) {
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb75faac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb75faac8) {
#line 78
    case 10:
#line 78
      __nesc_result = LoraWANC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb75faac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73a89f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73a89f8, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t LoraWANC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb75fa108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb75fa108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb75f8178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb75f8178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t LoraWANC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LoraWANC$Timer0$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
{
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "Radio on on node %d! at time %s\n", TOS_NODE_ID, sim_time_string());

      if ((((TOS_NODE_ID == 1 || TOS_NODE_ID == 2) || TOS_NODE_ID == 3) || TOS_NODE_ID == 4) || TOS_NODE_ID == 5) {
          LoraWANC$Timer0$startPeriodicAt(0, 5000);
        }
    }
  else {
...
#line 113
  LoraWANC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  LoraWANC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LoraWANC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73a8010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73a8010) {
#line 100
    case 0U:
#line 100
      /*LoraWANAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73a8010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77b4650){
#line 75
  switch (arg_0xb77b4650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77b4650);
#line 75
      break;
#line 75
    }
...
#line 53
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LoraWANC$Timer1$startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t LoraWANC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 166
  ...
  LoraWANC$msg_val[sim_node()] = LoraWANC$Random$rand16() % 200;
  LoraWANC$fill_pkt(msg_to_send, 0, LoraWANC$id_index[sim_node()], TOS_NODE_ID, LoraWANC$msg_val[sim_node()], 0);



  LoraWANC$current_type[sim_node()] = __nesc_ntoh_uint8(msg_to_send->type.nxdata);
  LoraWANC$current_id[sim_node()] = __nesc_ntoh_uint8(msg_to_send->id.nxdata);
  LoraWANC$current_sender[sim_node()] = __nesc_ntoh_uint8(msg_to_send->sender.nxdata);
  LoraWANC$current_content[sim_node()] = __nesc_ntoh_uint8(msg_to_send->content.nxdata);

  sim_log_debug(153U, "radio_rec", "current msg -> type: %d id: %d sender: %d content: %d\n", LoraWANC$current_type[sim_node()], LoraWANC$current_id[sim_node()], LoraWANC$current_sender[sim_node()], LoraWANC$current_content[sim_node()]);



  LoraWANC$actual_send(AM_BROADCAST_ADDR, &LoraWANC$packet[sim_node()]);
  sim_log_debug(154U, "radio_rec", "	msg sent at node %d\n", TOS_NODE_ID);
  LoraWANC$Timer1$startOneShot(1000);
  LoraWANC$id_index[sim_node()]++;
}
...
#line 190
{
  ...
  sim_log_debug(155U, "radio_rec", "	flag : %d\n", LoraWANC$flag_ack[sim_node()]);
...
#line 199
      ...
      sim_log_debug(156U, "radio_rec", "TIME EXPIRED\n");
      sim_log_debug(157U, "radio_rec", "RESEND MSG: type: %d id: %d sender: %d content: %d\n", LoraWANC$current_type[sim_node()], LoraWANC$current_id[sim_node()], LoraWANC$current_sender[sim_node()], LoraWANC$current_content[sim_node()]);
      LoraWANC$fill_pkt(msg_to_send, LoraWANC$current_type[sim_node()], LoraWANC$current_id[sim_node()], LoraWANC$current_sender[sim_node()], LoraWANC$current_content[sim_node()], 0);
      LoraWANC$actual_send(AM_BROADCAST_ADDR, &LoraWANC$packet[sim_node()]);
      LoraWANC$Timer1$startOneShot(1000);
    }
  else {
      sim_log_debug(158U, "radio_rec", "ACK arrived corrected \n");
      LoraWANC$flag_ack[sim_node()] = FALSE;
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb722ac70){
#line 83
  switch (arg_0xb722ac70) {
#line 83
    case 0U:
#line 83
      LoraWANC$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      LoraWANC$Timer1$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb722ac70);
#line 83
      break;
#line 83
    }
...
#line 97
{
  ...
  if ((LoraWANC$server_fd[sim_node()] = socket(2, SOCK_STREAM, 0)) == 0) {
      perror("Socket creation failed");
      exit(1);
    }

  LoraWANC$address[sim_node()].sin_family = 2;
  LoraWANC$address[sim_node()].sin_addr.s_addr = (in_addr_t )0x00000000;
  LoraWANC$address[sim_node()].sin_port = htons(60002);


  if (bind(LoraWANC$server_fd[sim_node()], (struct sockaddr *)&LoraWANC$address[sim_node()], sizeof LoraWANC$address[sim_node()]) < 0) {
      perror("Bind failed");
      exit(1);
    }


  if (listen(LoraWANC$server_fd[sim_node()], 3) < 0) {
      perror("Listen failed");
      exit(1);
    }


  if ((LoraWANC$new_socket[sim_node()] = accept(LoraWANC$server_fd[sim_node()], (struct sockaddr *)&LoraWANC$address[sim_node()], (socklen_t *)&LoraWANC$addrlen[sim_node()])) < 0) {
      perror("Accept failed");
      exit(1);
    }

  return LoraWANC$new_socket[sim_node()];
}
...
#line 72
  if (LoraWANC$locked[sim_node()]) {
      sim_log_debug(148U, "radio_send", "LOCKED!!!!\n");
      return;
    }
  else {
      if (LoraWANC$AMSend$send(address, packet, sizeof(lora_msg_t )) == SUCCESS) {
          LoraWANC$locked[sim_node()] = TRUE;
          sim_log_debug(149U, "radio_send", "Sending packet of type %d at time %s toward node %d gateInPkt: %d sender: %d content %d\n", __nesc_ntoh_uint8(packet_to_send->type.nxdata), sim_time_string(), address, __nesc_ntoh_uint8(packet_to_send->gateway.nxdata), __nesc_ntoh_uint8(packet_to_send->sender.nxdata), __nesc_ntoh_uint8(packet_to_send->content.nxdata));
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module LoraWANC */
  if (!strcmp(varname, "LoraWANC$packet"))
  {
    *addr = (uintptr_t)&LoraWANC$packet[__nesc_mote];
    *size = sizeof(LoraWANC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$locked"))
  {
    *addr = (uintptr_t)&LoraWANC$locked[__nesc_mote];
    *size = sizeof(LoraWANC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$id_index"))
  {
    *addr = (uintptr_t)&LoraWANC$id_index[__nesc_mote];
    *size = sizeof(LoraWANC$id_index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$msg_val"))
  {
    *addr = (uintptr_t)&LoraWANC$msg_val[__nesc_mote];
    *size = sizeof(LoraWANC$msg_val[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$saved_msg"))
  {
    *addr = (uintptr_t)&LoraWANC$saved_msg[__nesc_mote];
    *size = sizeof(LoraWANC$saved_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$current_type"))
  {
    *addr = (uintptr_t)&LoraWANC$current_type[__nesc_mote];
    *size = sizeof(LoraWANC$current_type[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$current_id"))
  {
    *addr = (uintptr_t)&LoraWANC$current_id[__nesc_mote];
    *size = sizeof(LoraWANC$current_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$current_sender"))
  {
    *addr = (uintptr_t)&LoraWANC$current_sender[__nesc_mote];
    *size = sizeof(LoraWANC$current_sender[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$current_content"))
  {
    *addr = (uintptr_t)&LoraWANC$current_content[__nesc_mote];
    *size = sizeof(LoraWANC$current_content[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$i"))
  {
    *addr = (uintptr_t)&LoraWANC$i[__nesc_mote];
    *size = sizeof(LoraWANC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$server_node"))
  {
    *addr = (uintptr_t)&LoraWANC$server_node[__nesc_mote];
    *size = sizeof(LoraWANC$server_node[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$flag_ack"))
  {
    *addr = (uintptr_t)&LoraWANC$flag_ack[__nesc_mote];
    *size = sizeof(LoraWANC$flag_ack[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$server_fd"))
  {
    *addr = (uintptr_t)&LoraWANC$server_fd[__nesc_mote];
    *size = sizeof(LoraWANC$server_fd[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$new_socket"))
  {
    *addr = (uintptr_t)&LoraWANC$new_socket[__nesc_mote];
    *size = sizeof(LoraWANC$new_socket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$address"))
  {
    *addr = (uintptr_t)&LoraWANC$address[__nesc_mote];
    *size = sizeof(LoraWANC$address[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$addrlen"))
  {
    *addr = (uintptr_t)&LoraWANC$addrlen[__nesc_mote];
    *size = sizeof(LoraWANC$addrlen[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$message"))
  {
    *addr = (uintptr_t)&LoraWANC$message[__nesc_mote];
    *size = sizeof(LoraWANC$message[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LoraWANC$message_len"))
  {
    *addr = (uintptr_t)&LoraWANC$message_len[__nesc_mote];
    *size = sizeof(LoraWANC$message_len[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&LoraWANC$msg_val[__nesc_mote], 0, sizeof LoraWANC$msg_val[__nesc_mote]);
  memset((void *)&LoraWANC$saved_msg[__nesc_mote], 0, sizeof LoraWANC$saved_msg[__nesc_mote]);
  memset((void *)&LoraWANC$current_type[__nesc_mote], 0, sizeof LoraWANC$current_type[__nesc_mote]);
  memset((void *)&LoraWANC$current_id[__nesc_mote], 0, sizeof LoraWANC$current_id[__nesc_mote]);
  memset((void *)&LoraWANC$current_sender[__nesc_mote], 0, sizeof LoraWANC$current_sender[__nesc_mote]);
  memset((void *)&LoraWANC$current_content[__nesc_mote], 0, sizeof LoraWANC$current_content[__nesc_mote]);
  LoraWANC$i[__nesc_mote] = 0;
  LoraWANC$server_node[__nesc_mote] = 8;
  LoraWANC$flag_ack[__nesc_mote] = FALSE;
  memset((void *)&LoraWANC$server_fd[__nesc_mote], 0, sizeof LoraWANC$server_fd[__nesc_mote]);
  memset((void *)&LoraWANC$new_socket[__nesc_mote], 0, sizeof LoraWANC$new_socket[__nesc_mote]);
  memset((void *)&LoraWANC$address[__nesc_mote], 0, sizeof LoraWANC$address[__nesc_mote]);
  LoraWANC$addrlen[__nesc_mote] = sizeof LoraWANC$address[__nesc_mote];
  memset((void *)&LoraWANC$message[__nesc_mote], 0, sizeof LoraWANC$message[__nesc_mote]);
  memset((void *)&LoraWANC$message_len[__nesc_mote], 0, sizeof LoraWANC$message_len[__nesc_mote]);
